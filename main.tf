...
module "etcd" {
  ...
  instance_type        = "${var.etcd_ami_size}"
...
module "etcdbastion" {
  ...
  channel              = "${var.channel}"
  virtualization_type  = "${var.virtualization_type}"
  instance_type        = "${var.bastion_ami_size}"
  ...
  asg_maximum_number_of_instances = "${var.bastion_asg_maximum_number_of_instances}"
...
module "kubenode" {
  ...
  channel              = "${var.channel}"
  virtualization_type  = "${var.virtualization_type}"
  instance_type        = "${var.kubenode_ami_size}"
  iam_instance_profile = "${module.iam.worker_profile_name}"
  key_name             = "${var.key_name}"
  security_group       = "${module.security.aws_security_group.bastion}"
